...
void RadauIIA3_dense(RKMethod *method)
{
    ...
    __declspec(align(16)) static const double A[][3] = {
    ...
    __declspec(align(16)) static const double c[3] = { 0.1550510257216822, 0.6449489742783178, 1.0 };
    //c[0] = 0.1550510257216822;
    //c[1] = 0.6449489742783178;
    //c[2] = 1.0;
    method->c = c;

    __declspec(align(16)) static const double e[4] = { -2.762305454748599, 0.379935598252729, -0.091629609865226, 0.2748888295956774 };
    ...
    */
    ...
    __declspec(align(16)) static const double d[4] = { -0.428298294115368, 0.245039074384917, -0.091629609865226, 0.2748888295956774 };
